...
class ShotOffTargetButton extends StatelessWidget {
  final String selectedPlayer; // Pass selected player from parent widget

  const ShotOffTargetButton({
    super.key,
      ...
      child: ElevatedButton(
        onPressed: () async {
          try {
            ...
            saveActionProvider.eventAction = 'Shot Off Target';

            // Handle score updates
            if (selectedPlayer == 'Opposition') {
              matchEventProvider.incrementOppShotOffXG();
            } else if (selectedPlayer.isNotEmpty) {
              matchEventProvider.incrementTeamShotOffXG();
            }
